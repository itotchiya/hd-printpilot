  ...
  return (
    <div className="space-y-10">
      <p className="text-muted-foreground text-base">
        Quel type de produit souhaitez-vous imprimer ?
      </p>
      ...
      {isDepliant && (
        <div className="border border-dashed border-amber-500/50 rounded-lg p-6 space-y-6 bg-amber-500/5 animate-in fade-in slide-in-from-top-4 duration-300">
